...
export default function ChatWindow() {
  ...
  return (
    <div className="h-full w-full flex flex-col">
      ...
      >
        {messages.length === 0 ? (
          <div className="flex flex-col items-center justify-center min-h-full text-center px-4 max-w-3xl mx-auto py-12">
          ...
          <div className="w-full max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-6 pb-8">
