    ...
    <div className="space-y-6">
        ...
        <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-2xl p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="bg-gray-50 dark:bg-gray-900/50 border border-gray-200 dark:border-gray-700 rounded-lg p-4">
              {selectedFile ? (
                <>
                  <div className="text-xs text-gray-600 dark:text-gray-400 mb-2 font-mono">{selectedFile.path}</div>
                  <pre className="text-sm text-gray-900 dark:text-gray-300 bg-white dark:bg-gray-900 p-3 rounded border border-gray-200 dark:border-gray-800 overflow-x-auto max-h-96">
      ...
      {project.setup && (
        <div className="bg-white dark:bg-gray-800/50 border border-gray-200 dark:border-gray-700 rounded-2xl p-6">
          ...
          <pre className="text-sm text-gray-800 dark:text-gray-300 bg-gray-50 dark:bg-gray-900/50 p-4 rounded-lg overflow-x-auto whitespace-pre-wrap border border-gray-200 dark:border-gray-800">
            {project.setup}
          </pre>
        </div>
      )}
